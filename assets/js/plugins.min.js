...
var showLeftPush = document.getElementById('btn-p-left'),
...
showLeftPush.onclick = function() {
  ...
  classie.toggle( leftMenu, 'mini' );
  disableOther( 'btn-p-left' );
};
function disableOther( button ) {
  if( button !== 'btn-p-left' ) {
